...
class MarketingTemplate extends Component {
  ...
  render() {
    ...
    const { shorttitle, shortdesc, title, description, canonical, og_image, hero, posts_category, latest_posts_text, language } = this.props.data.currentPost.frontmatter
