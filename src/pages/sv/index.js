...
class Startpage extends Component {
  ...
  render() {
    ...
    return (
      <Layout location="/sv/" show_contact_info>
        <SEO
        ...
        <Section class="blog-section">
          <div className="container">
            ...
            <BlogList language="sv" posts={posts} keepMobileStyling />
...
export const data = graphql`
  query {
    ...
    pageData: allMdx(filter: { fileAbsolutePath: { regex: "/(/startpage)/" } , frontmatter: {language: {eq: "sv"}}}) {
      edges {
        node {
          frontmatter {
            title
