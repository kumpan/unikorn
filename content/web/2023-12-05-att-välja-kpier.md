...
path: /sv/webbanalys/definiera-kpi/
...
description: "På Unikorn ser vi KPIer som mer än bara datapunkter; de kan likt
  norrstjärnan ge en tydlig riktling för vägen frammåt. "
canonical: https://www.unikorn.se/sv/webbanalys/definiera-kpi/
language: sv
menu_position: 4
og_image:
...
icon:
  ...
  alt: KPIer sätter riktningen, likt nordstjärnan
hero:
  heading: Att välja KPIer till din Webb
  ...
  featured_image:
    src: ../assets/kpi-definition-as-a-north-star.svg
    alt: KPIer sätter riktningen, likt nordstjärnan
latest_posts_text: Fler inlägg inom Analytics
...
![KPI urval](../assets/data-selection.png "KPI urval")